// ignore_for_file: file_names, prefer_const_constructors, sized_box_for_whitespace, avoid_unnecessary_containers, deprecated_member_use, avoid_print, must_be_immutable
...
class _AllSingleCategoryProductsScreenState extends State<AllSingleCategoryProductsScreen> {
  ...
  child: GestureDetector(
    onTap: () {
      print("Clicked on ${productModel.productImages}");
    },
    child: Container(
      width: Get.width / 2.2,
